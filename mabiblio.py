# -*- coding: utf-8 -*-
"""
Created on Sun Mar 20 20:23:13 2022
...
def affichageglobal(image,n):
    data_img = data_pixels(image,choixpts(image,n))
    Xq,qqch=ACPimg(data_img)
    ...
    imgmasqueponctuel,colors = Masque(data_img,qkayser,image)
